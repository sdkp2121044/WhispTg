...
# ... (rest of the code remains same as previous version for stats, allbots, broadcast, clone, remove, inline queries, etc.)
...
# Flask web server and main function remain same...
# ... (rest of the Flask and main code)
