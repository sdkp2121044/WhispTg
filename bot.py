...
async def check_user_joined_channel(user_id, client=None):
    """Check if user has joined the support channel - PROPER FORCE JOIN VERSION"""
    if client is None:
        client = bot
    ...
    try:
        ...
        # TEMPORARY: Testing ke liye sabko allow karo
        # ACTUAL IMPLEMENTATION: Jab bot channel admin ban jaye, toh yeh use karo:
        """
        try:
        ...
        # FOR TESTING: Hamesha force join show karo (sirf ADMIN ko chhod kar)
        return False
